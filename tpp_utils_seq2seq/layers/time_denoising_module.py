...
import math
from tpp_utils_seq2seq.layers.temporal_pos_enc import ContinuousSinusoidalPosEmb
...
class TimeDenoisingModule(nn.Module):
    ...
    def forward(self, x, e, t, hist, non_padding_mask):
        """
        ...
        output = self.decoder(tgt, memory, tgt_mask=tgt_mask,
                              memory_key_padding_mask=non_padding_mask)
